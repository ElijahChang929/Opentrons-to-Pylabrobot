...
await lh.aspirate([MEDIUM_VOL * 1.2], [final.bottom(z=0.2).move(Point(x=-2.5))], flow_rates=[0.2])
await lh.dispense([MEDIUM_VOL * 1.2], [waste.top(z=-5)], flow_rates=[3])
...
await lh.discard_tips()
await lh.pick_up_tips(next(tips))
await lh.aspirate([PBS_VOL], [pbs.bottom(z=0.5)], flow_rates=[3])
await lh.dispense([PBS_VOL + 20], [final.top(z=-2)], flow_rates=[0.3])
await lh.aspirate([PBS_VOL], [pbs.bottom(z=0.5)], flow_rates=[3])
await lh.dispense([PBS_VOL + 20], [final.top(z=-2)], flow_rates=[0.3])
await lh.aspirate([PBS_VOL], [pbs.bottom(z=0.5)], flow_rates=[3])
await lh.dispense([PBS_VOL + 20], [final.top(z=-2)], flow_rates=[0.3])
...
await lh.discard_tips()
await lh.pick_up_tips(next(tips))
await lh.aspirate([PBS_VOL * 1.5], [final.bottom(z=0.2).move(Point(x=-2.5))], flow_rates=[0.2])
await lh.dispense([PBS_VOL * 1.5], [waste.top(z=-5)], flow_rates=[3])
await lh.discard_tips()
await lh.pick_up_tips(next(tips))
await lh.aspirate([PBS_VOL * 1.5], [final.bottom(z=0.2).move(Point(x=-2.5))], flow_rates=[0.2])
await lh.dispense([PBS_VOL * 1.5], [waste.top(z=-5)], flow_rates=[3])
...
await lh.discard_tips()
await lh.pick_up_tips(next(tips))
await lh.aspirate([LYSIS_VOL], [lysis.bottom(z=0.5)], flow_rates=[0.5])
await lh.dispense([LYSIS_VOL], [final.bottom(z=5)], flow_rates=[0.3])
await lh.aspirate([LYSIS_VOL], [lysis.bottom(z=0.5)], flow_rates=[0.5])
await lh.dispense([LYSIS_VOL], [final.bottom(z=5)], flow_rates=[0.3])
await lh.aspirate([LYSIS_VOL], [lysis.bottom(z=0.5)], flow_rates=[0.5])
await lh.dispense([LYSIS_VOL], [final.bottom(z=5)], flow_rates=[0.3])
...
await lh.discard_tips()
await lh.pick_up_tips(next(tips))
await lh.aspirate([LUC_VOL], [luciferase.bottom(z=0.5)], flow_rates=[0.75])
await lh.dispense([LUC_VOL + 20], [final.top(z=-0.5)], flow_rates=[0.75])
